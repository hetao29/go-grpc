init:
	...
	protoc --include_imports \
               --include_source_info \
               --descriptor_set_out=reservation_service_definition.pb --proto_path=/Users/hetal/grpc/third_party/googleapis --proto_path=. --plugin=proto-google-common-protos --go_out=plugins=grpc:proto proto_src/user/profile/*.proto
	protoc --include_imports \
               --include_source_info \
               --descriptor_set_out=reservation_service_definition.pb --proto_path=/Users/hetal/grpc/third_party/googleapis --proto_path=. --plugin=proto-google-common-protos --go_out=plugins=grpc:proto proto_src/order/info/*.proto
